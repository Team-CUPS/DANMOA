  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        if (isInit) {
          _model.displayNameTextController.text = userData['display_name'] ?? '';
                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if(_model.displayNameTextController.text.trim() == "" || _model.dept == "" ||  _model.positionValue == "") {
                            showDialog(
                              context: context,
                          ...
                          if (isPickedImg == false) {
                            ...
                            await _firebaseService.updateProfile(currentUserUid, _model.displayNameTextController.text.trim(), _model.introTextController.text, _model.dept ?? "", _model.positionValue ?? "", returnedStringImg);
                            ...
                            await _firebaseService.updateProfile(currentUserUid, _model.displayNameTextController.text.trim(), _model.introTextController.text, _model.dept ?? "", _model.positionValue ?? "", photoUrl);
                          }

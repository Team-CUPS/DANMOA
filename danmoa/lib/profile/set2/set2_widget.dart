...
class _Set2WidgetState extends State<Set2Widget> {
  ...
  void initState() {
    ...
    _model.set2Tf03Controller ??= TextEditingController();
    _model.set2Tf03FocusNode ??= FocusNode();
  }
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                controller: _model.set2Tf03Controller,
                                focusNode: _model.set2Tf03FocusNode,
                                autofocus: false,
                                readOnly: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                textAlign: TextAlign.justify,
                                minLines: null,
                                validator: _model.set2Tf03ControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),

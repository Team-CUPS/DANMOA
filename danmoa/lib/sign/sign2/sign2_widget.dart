...
class _Sign2WidgetState extends State<Sign2Widget> {
  ...
  Future<bool> checkEmail(String email) async { // 이메일 중복검사
                          ...
                          if ((String pwVar) {
                            ...
                            if (_model.sign2Tf02TextController.text ==
                              ...
                              if (_model.sign2Chk01Values != null &&
                                ...
                                // 여기서 이메일 중복 확인
                                bool isUnique = await checkEmail(_model.sign2Tf01TextController.text);
                                if (isUnique) {
                                  context.pushNamed(
                                    'sign3',
                                    queryParameters: {
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  content: const Text('비밀번호는 영문자와 숫자를 사용해 8자이상 입력해주세요.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),

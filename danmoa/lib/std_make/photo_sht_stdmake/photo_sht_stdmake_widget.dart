...
import 'photo_sht_stdmake_model.dart';
export 'photo_sht_stdmake_model.dart';
import 'package:danmoa/backend/service/firebase_service.dart';

class PhotoShtStdmakeWidget extends StatefulWidget {
  PhotoShtStdmakeWidget({
    super.key,
  ...
  @override
  State<PhotoShtStdmakeWidget> createState() => _PhotoShtStdmakeWidgetState();
}

class _PhotoShtStdmakeWidgetState extends State<PhotoShtStdmakeWidget> {
  late PhotoShtStdmakeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhotoShtStdmakeModel());
  }

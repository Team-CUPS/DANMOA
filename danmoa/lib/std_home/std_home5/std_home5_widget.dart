                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (isPickedImg) {
                            String? photoUrl = await _firebaseService.storeStudyImageToStorage(returnedXfileImg?.path, 'profile', studyData['std_name']);
                            // picked되면 photoUrl는 null 불가능
                            await _firebaseService.updateStudyDetails(widget.stdName, stdPrfPicture: photoUrl!, stdIntro: _model.myBioTextController.text, stdPrfUrl: _model.cityTextController.text);
                          }
                          else {
                            await _firebaseService.updateStudyDetails(widget.stdName, stdPrfPicture: returnedStringImg, stdIntro: _model.myBioTextController.text, stdPrfUrl: _model.cityTextController.text);
                          }

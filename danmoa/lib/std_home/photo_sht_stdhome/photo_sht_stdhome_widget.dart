...
import 'photo_sht_stdhome_model.dart';
export 'photo_sht_stdhome_model.dart';
import 'package:danmoa/backend/service/firebase_service.dart';

class PhotoShtStdhomeWidget extends StatefulWidget {
  PhotoShtStdhomeWidget({
    super.key,
  ...
  @override
  State<PhotoShtStdhomeWidget> createState() => _PhotoShtStdhomeWidgetState();
}

class _PhotoShtStdhomeWidgetState extends State<PhotoShtStdhomeWidget> {
  late PhotoShtStdhomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhotoShtStdhomeModel());
  }
  ...
  Widget build(BuildContext context) {
    logger.w('결과: ${widget.isPickedImgSht}');
    return Column(

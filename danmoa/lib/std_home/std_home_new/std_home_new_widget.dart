...
import 'std_home_new_model.dart';
export 'std_home_new_model.dart';

class StdHomeNewWidget extends StatefulWidget {
  const StdHomeNewWidget({super.key});

  @override
  State<StdHomeNewWidget> createState() => _StdHomeNewWidgetState();
}

class _StdHomeNewWidgetState extends State<StdHomeNewWidget>
    with TickerProviderStateMixin {
  late StdHomeNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StdHomeNewModel());
